...
from .models import Property, Application, Lease, Payment, MaintenanceTicket, generate_payment_schedule
...
def applications_inbox(request):
    qs = Application.objects.select_related("rental_property", "tenant").order_by("-submitted_at")
...
def application_approve(request, pk):
    ...
    lease = Lease.objects.create(
        ...
        security_deposit=app.rental_property.monthly_rent,
        is_active=True,
    )
